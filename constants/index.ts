...
export const EXPERIENCES_DATA = [
  ...
  {
    title: "Head Graphic Designer — Cyber Security Society MUET",
    description:
      "Designed branding materials, logos, posters, and event visuals for the Cyber Security Society MUET, enhancing digital presence and visual identity.",
    icon1: "/icons/css.png",
    icon: React.createElement(LuPenTool),
...
// Owner name
export const OWNER_NAME = "Abdul Wasiu";
